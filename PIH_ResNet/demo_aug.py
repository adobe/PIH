...
text_scale = font.render("scaling factor: %f" % (scale_aug), True, green, blue)
textRect_scale = text_scale.get_rect()
textRect_scale.center = (2600 // 2, 300 // 2)
...
while 1:
            ...
            if event.user_type == pygame_gui.UI_BUTTON_PRESSED:
                ...
                if event.ui_element == run_button:
                    if model_selected and image_selected:
                        ...
                        scale_aug = 0.5
                        text_scale = font.render(
                            "scaling factor: %f" % (scale_aug), True, green, blue
                        )
                        Model.setscalor(scale_aug)
                        with torch.no_grad():
    ...
    window_surface.blit(text_scale, textRect_scale)

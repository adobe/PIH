...
lrd=4e-5
batch_size=8
date=20220904_a100_2_unetD_3_with_skip_resnet_maskinput_pl32_gan_loss_mask_lowdim_L105_reconwithgan_087_brush_offset07_upsample_lessskip_agg
reconweight=None
training_ratio=1
lutdim=16
inputdimD=3
recon_ratio=0.5
recon_weight=0.87 ## Used here

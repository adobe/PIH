...
lrd=3e-5
batch_size=8
date=20220827_a100_0_unetD_3_with_skip_resnet_maskinput_pl64_gan_loss_mask_lowdim_L105_reconwithgan_08_brush_offset07_swap_joint_effnet_32
reconweight=None
training_ratio=1
lutdim=16
inputdimD=3
recon_ratio=0.5
recon_weight=0.8 ## Used here

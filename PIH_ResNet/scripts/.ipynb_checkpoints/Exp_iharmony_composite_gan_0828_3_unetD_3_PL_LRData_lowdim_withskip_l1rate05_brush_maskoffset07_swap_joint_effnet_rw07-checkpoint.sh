...
lrd=4e-5
batch_size=8
date=20220828_a100_3_unetD_3_with_skip_resnet_maskinput_pl64_gan_loss_mask_lowdim_L105_reconwithgan_07_brush_offset07_swap_joint_effnet_32
reconweight=None
training_ratio=1
lutdim=16
inputdimD=3
recon_ratio=0.5
recon_weight=0.7 ## Used here

...
lrd=4e-5
batch_size=8
date=20221026_a100_1_raw_lowdim_L1_reconwithgan_brush_offset0_upsample_lessskip_agg_Ihd_composite_all_scheduler_resnet101_pixel
reconweight=None
training_ratio=1
lutdim=16
inputdimD=3
...
# Set folder names
dir_data=/mnt/localssd/Ihd_composite_all/test/

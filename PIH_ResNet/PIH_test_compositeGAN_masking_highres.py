...
def get_args():
    ...
    parser.add_option(
        "--original",
        action="store_true",
        help="If specified, will use original resolution.",
    )
    parser.add_option(
        "--lrdata",
        action="store_true",
    ...
    def __init__(self):
        ...
        if self.args.ihd:
            ...
            if self.args.ngt:
                ...
                if self.args.composite:
                    self.dataset = PIHData_Composite(self.args.datadir, lowres=self.args.lowres, original=self.args.original)
                else:

...
lrd=2e-5
batch_size=8
date=20220629_a10g_0_unetD_7_no_skip_resnet_lut_dim_16_maskinput_no_curve_l1ratio0_warmup1
reconweight=None
training_ratio=1
lutdim=16
inputdimD=7
...
name=iharmony_compositegan_D_${inputdimD}_ratio_${training_ratio}_noskip_lutdim${lutdim}_no_curve_reconratio_${recon_ratio}_warmup1

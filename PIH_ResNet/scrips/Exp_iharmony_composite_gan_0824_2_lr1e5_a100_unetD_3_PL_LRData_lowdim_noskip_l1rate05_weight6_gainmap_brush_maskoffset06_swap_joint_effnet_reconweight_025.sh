...
lrd=2e-5
batch_size=8
date=20220824_a100_2_unetD_3_no_skip_resnet_maskinput_pl64_gan_loss_mask_lowdim_L105_reconwithgan_025_brush_offset06_swap_joint_effnet_64
reconweight=None
training_ratio=1
lutdim=16
inputdimD=3
recon_ratio=0.5
recon_weight=0.25 ## Used here

...
lrd=3e-5
batch_size=6
date=202206161_a10g_10_unetD_withmask
inputdim=3
reconweight=None
training_ratio=0.2
name=iharmony_compositegan_7layerD_unet_test_with_mask_no_mask_input_${inputdim}_reconloss_${reconweight}_ration_${training_ratio}_unet_D_withmask

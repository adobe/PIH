...
lrd=5e-5
batch_size=8
date=20220908_a100_1_unetD_3_with_skip_resnet_maskinput_pl32_gan_loss_mask_lowdim_L105_reconwithgan_095_brush_offset07_upsample_lessskip_agg_Ihd_composite_all
reconweight=None
training_ratio=1
lutdim=16
inputdimD=3
recon_ratio=0.5
recon_weight=0.95 ## Used here

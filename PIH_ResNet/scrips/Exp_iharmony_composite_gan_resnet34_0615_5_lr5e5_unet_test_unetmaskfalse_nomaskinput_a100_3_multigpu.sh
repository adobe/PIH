...
lrd=1e-5
batch_size=40
date=202206156_a100_3
inputdim=3
name=iharmony_compositegan_7layerD_unet_test_no_mask_no_mask_input_inputdim_${inputdim}

model_name=exp_${date}_batch_size_$((batch_size))_lr_${lr}_${name}_device_${device}_multigpu

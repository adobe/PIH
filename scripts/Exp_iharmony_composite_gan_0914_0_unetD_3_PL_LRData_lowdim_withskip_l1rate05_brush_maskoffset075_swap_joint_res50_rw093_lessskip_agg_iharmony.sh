...
lrd=4e-5
batch_size=8
date=20220914_a100_0_unetD_3_pl32_gan_loss_mask_lowdim_L105_reconwithgan_094_brush_offset075_upsample_lessskip_agg_Ihd_composite_all_scheduler
reconweight=None
training_ratio=1
lutdim=16
inputdimD=3
recon_ratio=0.5
recon_weight=0.93 ## Used here

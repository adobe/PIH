...
lrd=1e-5
batch_size=8
date=20220817_a100_1_unetD_3_no_skip_resnet_maskinput_pl32_gan_loss_mask_lowdim_L105_reconwithgan_4_brush_offset06_swap_joint_pihnet_colorjitter_new
reconweight=None
training_ratio=1
lutdim=16
inputdimD=3
recon_ratio=0.5
recon_weight=5 ## Used here

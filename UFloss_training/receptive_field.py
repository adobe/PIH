# Code from https://github.com/Fangyh09/pytorch-receptive-field/
# Added small change for dilated convolution start point
        ...
        def hook(module, input, output):
            ...
            if not receptive_field["0"]["conv_stage"]:
                ...
                if class_name == "Conv2d" or class_name == "MaxPool2d":
                    ...
                    # Added `+ dilation - 1`. Not sure if it's the general rule, but fixes the case I'm working with.
                    receptive_field[m_key]["start"] = p_start + ((kernel_size - 1) / 2 - padding + dilation - 1) * p_j
